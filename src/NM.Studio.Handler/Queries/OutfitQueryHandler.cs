...
namespace NM.Studio.Handler.Queries
{
       ...
       IRequestHandler<OutfitGetByIdQuery, MessageResult<OutfitResult>>
    {
        ...
        public async Task<MessageResults<OutfitResult>> Handle(OutfitGetAllQuery request, CancellationToken cancellationToken)
        {
            return await _outfitService.GetAll(request, cancellationToken);
        }

        public async Task<MessageResult<OutfitResult>> Handle(OutfitGetByIdQuery request, CancellationToken cancellationToken)
        {
