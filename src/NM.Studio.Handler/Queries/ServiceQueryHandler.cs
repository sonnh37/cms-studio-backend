    ...
    IRequestHandler<ServiceGetByIdQuery, MessageResult<ServiceResult>>
{
    ...
    public async Task<MessageResults<ServiceResult>> Handle(ServiceGetAllQuery request,
        CancellationToken cancellationToken)
    {
        return await _serviceService.GetAll(request, cancellationToken);
    }

    public async Task<MessageResult<ServiceResult>> Handle(ServiceGetByIdQuery request,
        CancellationToken cancellationToken)
    {
